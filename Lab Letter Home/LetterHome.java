...
//chvtruon
//lab5
//This is a program that sends a letter to parents
//1st error: >= in "sentenceCode >= MAX_CODE" should be > because of returning true for 5, it should be returning false
//2nd error: the semicolon after if(m==2) made that statement useless.
//3rd error: there was a semicolon that was not suppose to be there after if(modifierCode == 3)
